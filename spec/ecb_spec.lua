...
describe("#ECB", function()
    ...
    it("encrypts and decrypts data", function()
        ...
        assert.equal(
                "\118\161\130\160\192\89\214\103\213\170\14\213\63\15\114\86\73\30\243\232\76\148\132\240\23\27\245\87\162\24\123\250\99\39\20\45\144\217\0\46",
                ciphertext)
        keychain:reset()
    ...
    describe("creation", function()
        it("fails when given an IV", function()
            assert.has.errors(function() blowfish.new(MODE, "any key", "somebits") end)
        end)
        ...
        it("fails when key is too short", function()
            assert.has_no.errors(function() blowfish.new(MODE, "four")  end)
        ...
        it("fails when key is too long", function()
            ...
            while (#key <= 56) do
                assert.has_no.errors(function() blowfish.new(MODE, key)  end)
                key = "b" .. key
            end
            assert.equal(57, #key)
    ...
    describe("encryption", function()
        local keychain
        setup(function()
            keychain = blowfish.new(MODE, KEY)
        end)
